<template>
  <div class="bg-clouds">
        ...
        <section class="module-onboarding container">
            ...
            <div ref="myModalRef" class="modal fade" role="dialog" id="confirmModal">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                      <button type="button" class="btn" @click="signup">Accept</button>
                  </div>
                </div>
              </div>
                </div>
...
export default {
  ...
  methods: {
    signup () {
      this.$cognitoAuth.signup(this.registerForm.email, this.registerForm.email, this.registerForm.password, (err, result) => {
        if (err) {
          this.error = err
          console.error(err)
        } else {
