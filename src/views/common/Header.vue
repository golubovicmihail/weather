  ...
  <div class="navbar navbar-fixed-top">
    <header>
        ...
        <div class="header__sign-in">
            <a title="Home" href="/" style="line-height: 88px;">Home</a>
            ...
            <router-link class="btn btn-green" to="register">Register</router-link>
            <router-link class="btn sign-in" to="login">Sign In</router-link>
        </div>
    </header>
</div>
</template>
